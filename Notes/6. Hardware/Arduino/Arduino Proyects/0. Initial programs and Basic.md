...
Es importante tener en cuenta que la función *digitalWrite* solo permite recibir el pin a modificar el voltaje y como segundo parametro la palabra reservada LOW indicando un voltaje de 0 y HIGH indicando un voltaje de 5 voltios. Ahora bien, la función *analogWrite* permite modificar los voltios transmitidos al circuito electrico indicando como primer parametro el pin y como segundo parametro un número entre el 0 y el 255 siendo 0 el equivalente a 0 voltios y 255 el equivalente a 5 voltios. Dado que tiene una potencia de 1 byte = 8 bits = 2^8 = 256.
