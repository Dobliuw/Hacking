...
El problema de este método es que, si bien es muy simple de llevar a cabo, de contruir y de entender, solo funciona bien si la señal está bien modulada y es extremadamente sensible al *ruido* e *interferencias*.
