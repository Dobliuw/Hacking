...
> [!warning] Motorola case
> En el caso de motorola tendremos un software (**Rescue and Smart Assistant** ([LMSA](https://support.lenovo.com/us/en/downloads/ds101291) por su nuevo nombre)) el cual nos permitirá recuperar la imagen del dispositivo que buscamos rotear, en caso de que sea un motorola.
