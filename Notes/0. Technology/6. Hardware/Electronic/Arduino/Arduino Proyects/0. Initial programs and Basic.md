...
Por ejemplo, en un simple circuito donde poseemos una fuente de 5v conectada a un cable jumper y este a una resistencia de 220 ohmios a su vez conectada a tierra, podemos hacer uso de la **Ley de Ohm** descrita en la sección de [[Notes/0. Technology/6. Hardware/Electronic/Electronic]] para determinar la corriente.
